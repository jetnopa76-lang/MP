...
const DEF_SITE = { logoText: "myphoto", accentColor: "#1a1a1a", freeShipMin: 109, guaranteeText: "100% Smile Guarantee", footerLinks: ["FAQ", "Reviews", "Privacy", "Terms"], adminPassword: "admin123", testMode: false, navItems: [
          ...
          <div style={{ background: "#fff", borderRadius: 16, padding: 24, border: "1px solid rgba(0,0,0,0.06)" }}>
            ...
            <div style={{ borderTop: "1px solid rgba(0,0,0,0.06)", paddingTop: 16 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
                ...
                <div>
                  <span style={{ fontSize: 14, fontWeight: 600, color: site.testMode ? "#e8a020" : "#555" }}>Test Mode {site.testMode ? "ON" : "OFF"}</span>
                  <div style={{ fontSize: 11, color: "#999" }}>When on, checkout shows a "Place Test Order" button that skips payment. Test orders are marked with a badge in the orders list.</div>
                </div>
              </div>
