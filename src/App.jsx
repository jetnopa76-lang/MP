    ...
    <div style={{ minHeight: "100vh", background: (design||DEF_DESIGN).bgColor, fontFamily: `'${(design||DEF_DESIGN).bodyFont}', sans-serif`, color: (design||DEF_DESIGN).textColor }}>
      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        .grid-products { display: grid; grid-template-columns: repeat(auto-fill, minmax(${Math.round(900 / (ds.cardColumns || 3) - (ds.cardGap || 16))}px, 1fr)); gap: ${ds.cardGap || 16}px; }
      ...
      {site.testMode && (
        <div style={{ background: "#e8a020", color: "#fff", textAlign: "center", padding: "5px 12px", fontSize: 11, fontWeight: 600, fontFamily: F, letterSpacing: 0.5 }}>⚠ TEST MODE — Orders will not be charged</div>
      )}
        ...
        <div style={{ background: "#f5f4f2", borderBottom: "1px solid rgba(0,0,0,0.06)", padding: "10px 24px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, maxWidth: 980, margin: "0 auto" }}>
            ...
            <button onClick={() => poolFileRef.current?.click()} style={{ width: 52, height: 52, borderRadius: 10, border: "2px dashed rgba(0,0,0,0.12)", background: "transparent", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 2, flexShrink: 0 }}>
              ...
              <span style={{ fontSize: 8, color: "#aaa", fontFamily: F, fontWeight: 600 }}>Add</span>
            </button>
              ...
              <div>
                ...
                <div>
                  ...
                  <div style={{ display: "flex", gap: 5, flexWrap: "wrap" }}>
                    {active.filter(p => p.id !== selProd.id).map(p => <button key={p.id} onClick={() => switchProduct(p)} style={{ padding: "6px 10px", borderRadius: 7, cursor: "pointer", fontFamily: F, fontSize: 11, fontWeight: 500, border: "1px solid rgba(0,0,0,0.08)", background: "#fff" }}>{p.name}</button>)}
                  </div>
                </div>
              </div>
            </div>);
            ...
            <div className="grid-customize">
              ...
              <div>
                ...
                <div style={{ marginBottom: 14 }}>
                  ...
                  <div style={{ display: "flex", gap: 5, flexWrap: "wrap" }}>
                    {active.map(p => <button key={p.id} onClick={() => switchProduct(p)} style={{ padding: "6px 10px", borderRadius: 7, cursor: "pointer", fontFamily: F, fontSize: 11, fontWeight: 500, border: selProd.id === p.id ? `2px solid ${ac}` : "1px solid rgba(0,0,0,0.08)", background: selProd.id === p.id ? "#faf9f7" : "#fff" }}>{p.name}</button>)}
                  </div>
                </div>
              ...
              <div style={{ background: "#fff", borderRadius: 14, padding: 20, border: "1px solid rgba(0,0,0,0.06)" }}>
                ...
                {site.testMode && (
                  <button onClick={async () => {
                    ...
                    setGenerating(false);
                  }} disabled={generating} style={{ width: "100%", marginTop: 16, background: generating ? "#999" : "#e8a020", color: "#fff", border: "none", padding: 15, borderRadius: 10, fontSize: 15, fontFamily: F, fontWeight: 700, cursor: generating ? "wait" : "pointer" }}>
