          ...
          {selProd && !imageUrl && (() => {
            ...
            <div className="grid-customize">
              ...
              <div>
                ...
                {/* Upload CTA — right under product image, compact */}
                <div onDragOver={e => { e.preventDefault(); setDragO(true); }} onDragLeave={() => setDragO(false)} onDrop={handleDrop}
                  onClick={() => fileRef.current?.click()}
                  style={{ marginTop: 10, border: `2px dashed ${dragO ? ac : "rgba(0,0,0,0.12)"}`, borderRadius: 12, padding: "16px 14px", textAlign: "center", cursor: "pointer", background: dragO ? "rgba(0,0,0,0.01)" : "#fff", transition: "all 0.2s", display: "flex", alignItems: "center", gap: 12, justifyContent: "center" }}>
                  <div style={{ fontSize: 20, opacity: 0.3 }}>⬆</div>
                  <div style={{ textAlign: "left" }}>
                    <div style={{ fontWeight: 600, fontSize: 14, color: ac }}>Upload {frameCount > 1 ? `${frameCount} photos` : "your photo"}</div>
                    <div style={{ color: "#aaa", fontSize: 11 }}>JPG, PNG, or WEBP{frameCount > 1 ? " · Select multiple" : ""}</div>
                  </div>
