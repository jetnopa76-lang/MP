        ...
        {step === 0 && (<div>
          ...
          <div style={{ maxWidth: 900, margin: "0 auto", padding: "44px 24px 72px" }}>
            ...
            <div className="grid-products">
              {filtP.map(p => (<div key={p.id} onClick={() => { switchProduct(p); setStep(2); }} style={{ borderRadius: 14, overflow: "hidden", cursor: "pointer", background: "#fff", border: "1px solid rgba(0,0,0,0.05)", transition: "all 0.3s" }}
